...
public class Shipment 
{
	...
	public void shipment() throws InterruptedException 
	{
	 ...
	 /*
	 WebElement select_inv=  selt_inv.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//android.view.View[@content-desc=\"Select\"]/android.widget.TextView")));
	 select_inv.click();
